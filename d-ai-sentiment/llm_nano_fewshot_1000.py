"""
Few-shot sentiment analysis using Azure OpenAI GPT-4.1-nano with 1000 training examples.
"""
...
MODEL_CONFIG = {
    ...
    "model_display_name": "GPT-4.1-nano"
}


def main():
    """Main function to run few-shot sentiment analysis with GPT-4.1-nano using 1000 examples."""
    try:
        # Load examples from train/train_1000.csv
        examples_path = "train/train_1000.csv"
        ...
        analysis = AnalysisUtils(experiment_name="llm_nano_fewshot_1000")
