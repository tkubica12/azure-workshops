"""
Few-shot sentiment analysis using Azure OpenAI fine-tuned GPT-4.1-nano with 100 training examples.
"""
...
# Model configuration
MODEL_CONFIG = {
    "deployment_name": "nano-2025-04-14-kubicasentiment",
    "api_version": "2024-12-01-preview",
    "input_cost_per_1k": 0.0001,  # $0.0001 per 1K input tokens for GPT-4.1-nano
    "output_cost_per_1k": 0.0004,  # $0.0004 per 1K output tokens for GPT-4.1-nano
    "model_display_name": "GPT-4.1-nano (Fine-tuned)"
}


def main():
    """Main function to run few-shot sentiment analysis with fine-tuned GPT-4.1-nano using 100 examples."""
    try:
        # Load examples from train/train_100.csv
        examples_path = "train/train_100.csv"
        ...
        analysis = AnalysisUtils(experiment_name="llm_ft_nano_fewshot_100")
