"""
Zero-shot sentiment analysis using Azure OpenAI GPT-4.1-nano.
"""
...
def main():
    """Main function to run zero-shot sentiment analysis with GPT-4.1-nano."""
    try:
        ...
        analysis = AnalysisUtils(experiment_name="llm_nano_zeroshot")
