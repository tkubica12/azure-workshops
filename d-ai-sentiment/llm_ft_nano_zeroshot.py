"""
Zero-shot sentiment analysis using Azure OpenAI fine-tuned GPT-4.1-nano.
"""
...
def main():
    """Main function to run zero-shot sentiment analysis with fine-tuned GPT-4.1-nano."""
    try:
        ...
        analysis = AnalysisUtils(experiment_name="llm_ft_nano_zeroshot")
