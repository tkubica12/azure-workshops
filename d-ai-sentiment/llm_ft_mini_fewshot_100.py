"""
Few-shot sentiment analysis using Azure OpenAI fine-tuned GPT-4.1-mini with 100 training examples.
"""
...
def main():
    """Main function to run few-shot sentiment analysis with fine-tuned GPT-4.1-mini using 100 examples."""
    try:
        ...
        analysis = AnalysisUtils(experiment_name="llm_ft_mini_fewshot_100")
