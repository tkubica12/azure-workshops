#!/usr/bin/env python3
"""
Test logistic regression model trained on all embedding samples.
...
MODEL_CONFIG = {
    ...
    "model_file": "models/lr_model_all.pkl",
    "embedding_model": "text-embedding-3-small",
    "input_cost_per_1k": 0.00002,  # Cost for embedding generation
    "output_cost_per_1k": 0.0,
    "model_display_name": "LR-All"
}


def main():
    """Main function to test logistic regression model trained on all samples."""
    try:
        ...
        if not os.path.exists(model_path):
            ...
            print("Please run train_lr_all.py first to train the model.")
            return
        ...
        analysis = AnalysisUtils(experiment_name="test_lr_all")
