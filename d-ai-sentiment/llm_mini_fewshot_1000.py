"""
Few-shot sentiment analysis using Azure OpenAI GPT-4.1-mini with 1000 training examples.
"""
...
def main():
    """Main function to run few-shot sentiment analysis with GPT-4.1-mini using 1000 examples."""
    try:
        ...
        analysis = AnalysisUtils(experiment_name="llm_mini_fewshot_1000")
