"""
Few-shot sentiment analysis using Azure OpenAI GPT-4.1-nano with 100 training examples.
"""
...
def main():
    """Main function to run few-shot sentiment analysis with GPT-4.1-nano using 100 examples."""
    try:
        ...
        analysis = AnalysisUtils(experiment_name="llm_nano_fewshot_100")
