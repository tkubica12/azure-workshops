"""
Zero-shot sentiment analysis using Azure OpenAI GPT-4.1-mini.
"""
...
def main():
    """Main function to run zero-shot sentiment analysis with GPT-4.1-mini."""
    try:
        ...
        analysis = AnalysisUtils(experiment_name="llm_mini_zeroshot")
