...
resource "azapi_resource" "NodeRecordingRulesRuleGroup" {
  ...
  name      = "NodeRecordingRulesRuleGroup-aks1"
  location  = azurerm_monitor_workspace.main.location
...
resource "azapi_resource" "KubernetesReccordingRulesRuleGroup" {
  type      = "Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01"
  name      = "KubernetesReccordingRulesRuleGroup-aks1"
  location  = azurerm_monitor_workspace.main.location
  parent_id = azurerm_resource_group.main.id
  body = jsonencode({
    "properties" : {
...
resource "azapi_resource" "NodeRecordingRulesRuleGroupWin" {
  type      = "Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01"
  name      = "NodeRecordingRulesRuleGroup-Win-aks1"
  location  = azurerm_monitor_workspace.main.location
  parent_id = azurerm_resource_group.main.id
  body = jsonencode({
    "properties" : {
...
resource "azapi_resource" "NodeAndKubernetesRecordingRulesRuleGroupWin" {
  type      = "Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01"
  name      = "NodeAndKubernetesRecordingRulesRuleGroup-Win-aks1"
  location  = azurerm_monitor_workspace.main.location
  parent_id = azurerm_resource_group.main.id
  body = jsonencode({
    "properties" : {
