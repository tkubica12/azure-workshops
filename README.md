...
- [AI with monitoring](./d-ai-with-monitoring/)
...
- [AI application patterns](./d-ai-app-patterns/)
- [Compare AI orchestrations](./d-ai-compare-orchestrations/)
- [Azure AI Content Understanding](./d-ai-content-understanding/)
- [AI Email Processing](./d-ai-email-processing/)
- [GPT Image Generation](./d-ai-gpt-image-1/)
- [Multi-Agent Framework (MAF) with Observability](./d-ai-maf-observability/)
- [Model Context Protocol (MCP)](./d-ai-mcp/)
- [AI Foundry Agent with VNet Integration](./d-ai-froundy-agent-vnet/)
- [AI Hybrid OSS and Cloud](./d-ai-hybrid-oss-cloud/)
...
- [AKS with ArgoCD and Argo Rollouts](./d-aks-argo-cd-and-rollouts/)
...
- [AKS Application Gateway for Containers (ALB)](./d-aks-alb/)
- [AKS API Server VNet Integration](./d-aks-api-server-vnet/)
- [AKS CNI Overlay](./d-aks-cni-overlay/)
- [AKS Developer Experience](./d-aks-devexperience/)
- [AKS Static Egress Gateway](./d-aks-static-egress-gw/)
- [AKS Isolated](./d-aks-network-isolated/)
- [AKS Node Autoprovisioning (Karpenter)](./d-aks-karpenter/)
  
## Other demos
- [Azure Managed Redis](./d-azure-managed-redis/)
- [Azure API Management](./d-api-management/)
- [Azure API Management with AI](./d-apim-ai/)
...
- [Front Door for DR](./d-frontdoor-dr/)
- [Application Gateway with cert in Key Vault](./d-appgw-kv/)
- [Azure Governance](./d-governance/)
- [IaaS Cloud Native](./d-iaas-cloudnative/)
- [Scalability patterns](./d-scalability/)
- [Azure Show demos](./d-azure-show/)
...
- [Azure Container Apps](./w-container-apps/)
